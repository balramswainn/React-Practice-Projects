        ...
        <div className='flex gap-7 items-center'>
            ...
            <div className='flex gap-1 cursor-pointer text-gray-700 items-center'>
              ...
              <span className='font-semibold '>
                          {location ? <div className='-space-y-2' onClick={toggleDropdown}>  
                            <p>{location.city}</p>
                            <p>{location.suburb}</p>
                            
                        </div> : <span onClick={toggleDropdown} >   
            ...
            </div>
               {
                 ...
                 <button onClick={getLocation}  className='bg-red-500 text-white px-3 py-1 rounded-md cursor-pointer hover:bg-red-400' >Detect my location</button> {/* onClick pe jab user chahe tab manually location detect kare.*/}
                 </div> : null
               }
         </div>
